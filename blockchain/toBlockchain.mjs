...
export async function sendToBlockchain(ipfsMeta){
    ...
    var addressContract = "0x36175E20A44d6f0658BE173904Eff08a265C8016";
    var toAddress;
    ...
    web3.eth.getAccounts().then(function(accounts) {
        ...
        var contract = new Contract(abi, addressContract);



        contract.methods.safeMint(web3.eth.defaultAccount, ipfsMeta).send({
